...
const char helpStr11[] PROGMEM = "Speaker Volume: ATLn";
const char helpStr12[] PROGMEM = "Speaker.On/Off: ATMn";
const char helpStr13[] PROGMEM = "Handle Telnet.: ATNETn";
const char helpStr14[] PROGMEM = "Leave cmd mode: ATO";
const char helpStr15[] PROGMEM = "Quiet mode....: ATQn";
const char helpStr16[] PROGMEM = "NIST date.time: ATRD/ATRT";
const char helpStr17[] PROGMEM = "Auto answer...: ATS0=n";
const char helpStr18[] PROGMEM = "Verbose mode..: ATVn";
const char helpStr19[] PROGMEM = "Extended codes: ATXn";
const char helpStr20[] PROGMEM = "Modem reset...: ATZ";
const char helpStr21[] PROGMEM = "DTR handling..: AT&D";
const char helpStr22[] PROGMEM = "CTS status....: AT&CSn";
const char helpStr23[] PROGMEM = "Fact. defaults: AT&F";
const char helpStr24[] PROGMEM = "Flow control..: AT&Kn";
const char helpStr25[] PROGMEM = "Server passwd.: AT&R=server password";
const char helpStr26[] PROGMEM = "RTS status....: AT&RS?";
const char helpStr27[] PROGMEM = "Show settings.: AT&Vn";
const char helpStr28[] PROGMEM = "Update NVRAM..: AT&W";
const char helpStr29[] PROGMEM = "Set speed dial: AT&Zn=host[:port],alias";
const char helpStr30[] PROGMEM = "Auto execute..: AT$AE=AT command";
const char helpStr31[] PROGMEM = "Are You There?: AT$AYT";
const char helpStr32[] PROGMEM = "Busy message..: AT$BM=busy message";
const char helpStr33[] PROGMEM = "Hostname......: AT$HOST=hostname";
const char helpStr34[] PROGMEM = "mDNS name.....: AT$MDNS=mDNS name";
const char helpStr35[] PROGMEM = "WiFi password.: AT$PASS=WiFi password";
const char helpStr36[] PROGMEM = "Serial speed..: AT$SB=n";
const char helpStr37[] PROGMEM = "Server port...: AT$SP=n";
const char helpStr38[] PROGMEM = "WiFi SSID.....: AT$SSID=ssid";
const char helpStr39[] PROGMEM = "Data config...: AT$SU=dps";
const char helpStr40[] PROGMEM = "Location......: AT$TTL=telnet location";
const char helpStr41[] PROGMEM = "Terminal size.: AT$TTS=WxH";
const char helpStr42[] PROGMEM = "Terminal type.: AT$TTY=terminal type";
const char helpStr43[] PROGMEM = "Startup wait..: AT$W=n";
const char helpStr44[] PROGMEM = "";
const char helpStr45[] PROGMEM = "Query most commands followed by '?'";
const char helpStr46[] PROGMEM = "e.g. ATQ?, AT&K?, AT$SSID?";
const char helpStr47[] PROGMEM = "";
...
const char* const helpStrs[] PROGMEM = {
   ...
   helpStr43, helpStr44, helpStr45, helpStr46, helpStr47
};
